    ...
    <div
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p
          ...
          Here's a look at what I've cultivated in my recent years. A timeline of my journey.
        </p>
      </div>
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        <div
          ...
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-gray-950 via-gray-400 to-transparent from-[0%] via-[10%] rounded-full" />
        </div>
      </div>
    </div>
  );
