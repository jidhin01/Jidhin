...
const Icons = {
  linkedin: () => (
    <FaLinkedin className="text-black group-hover:fill-sky-600 transition-all duration-500 ease-in-out" size={60} />
  ),
  github: () => (
    <FaGithub className="text-black group-hover:fill-gray-950 transition-all duration-500 ease-in-out" size={60} />
  ),
  StackOverflow: () => (
    <FaStackOverflow className="text-black group-hover:fill-orange-500 transition-all duration-500 ease-in-out" size={60} />
  ),
  Twitter: () => (
    <FaSquareXTwitter className="text-black group-hover:fill-blue-500 transition-all duration-500 ease-in-out" size={60} />
  ),
};
