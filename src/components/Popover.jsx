  ...
  return (
    <div key={title} className="flex min-h-[300px] w-full items-center justify-center">
      <motion.button
        ...
        className="flex h-9 items-center border bg-white  px-3 text-sm font-medium outline-none"
      >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            layoutId={`${title}-wrapper`}
            className="absolute p-1 overflow-hidden bg-muted outline-none"
            ref={ref}
            ...
            <AnimatePresence mode="popLayout">
              {showSuccess ? (
                ...
                <motion.div
                  ...
                  className="h-full border bg-white  z-20 "
                >
                  {openChild}
                </motion.div>
              )}
...
// CutOut Icons remain unchanged; JSX doesn't need typing changes here
...
export function PopoverFormCutOutLeftIcon() {
  return (
    <svg width="6" height="12" viewBox="0 0 6 12" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_2029_22)">
        <path d="M0 2..." className="fill-muted" />
        <path d="M1 12..." className="stroke-border" strokeWidth="1" strokeLinejoin="round" />
      </g>
      <defs>
        <clipPath id="clip0_2029_22">
...
// Don't forget to export PopoverForm
